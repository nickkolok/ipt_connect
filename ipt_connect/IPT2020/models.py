...
class Participant(models.Model):
	...
	#photo = models.ImageField(upload_to=UploadToPathAndRename('IPT2020/id_photo'),help_text="Please use a clear ID photo. This will be used for badges and transportation cards.", null=True)
...
class Team(models.Model):
	...
	IOC = models.OneToOneField(User, on_delete=models.SET_NULL, null=True, blank=True,related_name='Team_IPT2020',verbose_name="Admin")
