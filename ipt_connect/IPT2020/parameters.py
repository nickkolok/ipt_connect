...
# Views parameters
app_version = "IPT2020"[3:]     # keyword for url parsing
# TODO:
# The construction `"IPT2020"[3:]` above is a dirty hack.
# We need to mention `IPT2020` to enable automated cloning,
...
fights = {
    ...
    'names': ['Selective Fight 1','Selective Fight 2','Selective Fight 3','Selective Fight 4','Semifinal 1','Semifinal 2','IPT2020 Final']
}