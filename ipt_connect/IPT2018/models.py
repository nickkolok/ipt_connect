...
class Participant(models.Model):
	...
	phone_number = models.CharField(max_length=20,validators=[phone_regex], blank=True,help_text="At least one per team, for the LOC to join the team before and during the tournament if needed.") # validators should be a list
...
class Team(models.Model):
	...
	IOC = models.OneToOneField(User, on_delete=models.SET_NULL, null=True, blank=True,related_name='Team_IPT2018',verbose_name="Admin")
